...
class Vendas extends CI_Controller{
    public function nova(){
        $usuario = autoriza();
        $this->load->helper("date");//não seria date_helper, que foi criado?
        ...
        $config["smtp_user"] = "email.trindade.alexandre@gmail.com";
        $config["smtp_pass"] = "344351965";
        ...
        $this->session->set_flashdata("success","Pedido de compras efetuado com sucesso");
        redirect("/");
    }
